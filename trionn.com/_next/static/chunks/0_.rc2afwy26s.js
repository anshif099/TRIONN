(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 17831, (e, t, n) => {
    "use strict";
    var r, o;
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.Doctype = n.CDATA = n.Tag = n.Style = n.Script = n.Comment = n.Directive = n.Text = n.Root = n.isTag = n.ElementType = void 0, (o = r = n.ElementType || (n.ElementType = {})).Root = "root", o.Text = "text", o.Directive = "directive", o.Comment = "comment", o.Script = "script", o.Style = "style", o.Tag = "tag", o.CDATA = "cdata", o.Doctype = "doctype", n.isTag = function(e) {
        return e.type === r.Tag || e.type === r.Script || e.type === r.Style
    }, n.Root = r.Root, n.Text = r.Text, n.Directive = r.Directive, n.Comment = r.Comment, n.Script = r.Script, n.Style = r.Style, n.Tag = r.Tag, n.CDATA = r.CDATA, n.Doctype = r.Doctype
}, 11304, (e, t, n) => {
    "use strict";
    var r, o = e.e && e.e.__extends || (r = function(e, t) {
    ...
    n.Element = m, n.isTag = g, n.isCDATA = y, n.isText = v, n.isComment = E, n.isDirective = b, n.isDocument = x, n.hasChildren = function(e) {
        return Object.prototype.hasOwnProperty.call(e, "children")
    }, n.cloneNode = T
}, 92599, (e, t, n) => {
    "use strict";
    var r = e.e && e.e.__createBinding || (Object.create ? function(e, t, n, r) {
            void 0 === r && (r = n);
        ...
        o = e.e && e.e.__exportStar || function(e, t) {
    ...
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.CARRIAGE_RETURN_PLACEHOLDER_REGEX = n.CARRIAGE_RETURN_PLACEHOLDER = n.CARRIAGE_RETURN_REGEX = n.CARRIAGE_RETURN = n.CASE_SENSITIVE_TAG_NAMES_MAP = n.CASE_SENSITIVE_TAG_NAMES = void 0, n.CASE_SENSITIVE_TAG_NAMES = ["animateMotion", "animateTransform", "clipPath", "feBlend", "feColorMatrix", "feComponentTransfer", "feComposite", "feConvolveMatrix", "feDiffuseLighting", "feDisplacementMap", "feDropShadow", "feFlood", "feFuncA", "feFuncB", "feFuncG", "feFuncR", "feGaussianBlur", "feImage", "feMerge", "feMergeNode", "feMorphology", "feOffset", "fePointLight", "feSpecularLighting", "feSpotLight", "feTile", "feTurbulence", "foreignObject", "linearGradient", "radialGradient", "textPath"], n.CASE_SENSITIVE_TAG_NAMES_MAP = n.CASE_SENSITIVE_TAG_NAMES.reduce(function(e, t) {
        return e[t.toLowerCase()] = t, e
    }, {}), n.CARRIAGE_RETURN = "\r", n.CARRIAGE_RETURN_REGEX = RegExp(n.CARRIAGE_RETURN, "g"), n.CARRIAGE_RETURN_PLACEHOLDER = "__HTML_DOM_PARSER_CARRIAGE_RETURN_PLACEHOLDER_".concat(Date.now().toString(), "__"), n.CARRIAGE_RETURN_PLACEHOLDER_REGEX = RegExp(n.CARRIAGE_RETURN_PLACEHOLDER, "g")
}, 73217, (e, t, n) => {
    "use strict";
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.formatAttributes = i, n.hasOpenTag = function(e, t) {
        var n = "<" + t,
    ...
    }, n.revertEscapedCharacters = a, n.formatDOM = function e(t, n, l) {
        void 0 === n && (n = null);
        for (var s, c, u, p, d, f = [], h = 0, m = t.length; h < m; h++) {
            var g = t[h];
            switch (g.nodeType) {
                case 1:
                    var y = function(e) {
                        var t, n = (t = e = e.toLowerCase(), o.CASE_SENSITIVE_TAG_NAMES_MAP[t]);
                        return n || e
                    }(g.nodeName);
                    (d = new r.Element(y, i(g.attributes))).children = e("template" === y ? g.content.childNodes : g.childNodes, d);
                    break;
                case 3:
                    d = new r.Text(a(null != (s = g.nodeValue) ? s : ""));
                    break;
                case 8:
                    d = new r.Comment(null != (c = g.nodeValue) ? c : "");
                    break;
                default:
                    continue
            }
            var v = null != (u = f[h - 1]) ? u : null;
            v && (v.next = d), d.parent = n, d.prev = v, d.next = null, f.push(d)
        }
        return l && ((d = new r.ProcessingInstruction(l.substring(0, l.indexOf(" ")).toLowerCase(), l)).next = null != (p = f[0]) ? p : null, d.parent = n, f.unshift(d), f[1] && (f[1].prev = f[0])), f
    };
    var r = e.r(92599),
        o = e.r(99235);
    ...
    Object.defineProperty(n, "__esModule", {
        ...
        var t, n, p, d, f, h, g = s.exec(e = (0, o.escapeSpecialCharacters)(e)),
            y = null == (t = null == g ? void 0 : g[1]) ? void 0 : t.toLowerCase();
        switch (y) {
            case i:
                var v = u(e);
                if (!(0, o.hasOpenTag)(e, a)) {
                    var E = v.querySelector(a);
                    null == (n = null == E ? void 0 : E.parentNode) || n.removeChild(E)
                }
                if (!(0, o.hasOpenTag)(e, l)) {
                    var E = v.querySelector(l);
                    null == (p = null == E ? void 0 : E.parentNode) || p.removeChild(E)
                }
                return v.querySelectorAll(i);
            case a:
            case l:
                var b = c(e).querySelectorAll(y);
                if ((0, o.hasOpenTag)(e, l) && (0, o.hasOpenTag)(e, a)) return null != (f = null == (d = b[0].parentNode) ? void 0 : d.childNodes) ? f : m();
                return b;
            default:
                if (r) return r(e);
                var E = c(e, l).querySelector(l);
                return null != (h = null == E ? void 0 : E.childNodes) ? h : m()
        }
    };
    var r, o = e.r(73217),
        i = "html",
    ...
    n.SAME = 0, n.CAMELCASE = 1, n.possibleStandardNames = {
        accept: 0,
        acceptCharset: 1,
    ...
    } = e.r(59878), u = RegExp.prototype.test.bind(RegExp("^(data|aria)-[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$")), p = Object.keys(c).reduce((e, t) => {
        let n = c[t];
        return n === s ? e[t] = t : n === l ? e[t.toLowerCase()] = t : e[t] = n, e
    }, {});
    n.BOOLEAN = 3, n.BOOLEANISH_STRING = 2, n.NUMERIC = 5, n.OVERLOADED_BOOLEAN = 4, n.POSITIVE_NUMERIC = 6, n.RESERVED = 0, n.STRING = 1, n.getPropertyInfo = function(e) {
        return o.hasOwnProperty(e) ? o[e] : null
    }, n.isCustomAttribute = u, n.possibleStandardNames = p
}, 26568, (e, t, n) => {
    "use strict";
    var r = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g,
        o = /\n/g,
    ...
    t.exports = function(e, t) {
        ...
        function m(r) {
            var o = Error(t.source + ":" + n + ":" + u + ": " + r);
            if (o.reason = r, o.filename = t.source, o.line = n, o.column = u, o.source = e, t.silent);
            else throw o
        }
        ...
        for (y(b); E = function() {
                ...
                if (t) {
                    ...
                    var n = g(s),
                        o = e({
                            type: "declaration",
                            property: p(t[0].replace(r, "")),
                            value: n ? p(n[0].replace(r, "")) : ""
                        });
                    return g(c), o
                }
            }();) !1 !== E && (b.push(E), y(b));
    ...
    n.camelCase = function(e, t) {
        var n;
        return (void 0 === t && (t = {}), !(n = e) || i.test(n) || r.test(n)) ? e : (e = e.toLowerCase(), (e = t.reactCompat ? e.replace(l, c) : e.replace(a, c)).replace(o, s))
    }
}, 15511, (e, t, n) => {
    "use strict";
    var r = (e.e && e.e.__importDefault || function(e) {
    ...
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.returnFirstArg = n.canTextBeChildOfNode = n.ELEMENTS_WITH_NO_TEXT_CHILDREN = n.PRESERVE_CUSTOM_ATTRIBUTES = void 0, n.isCustomComponent = function(e, t) {
        return e.includes("-") ? !a.has(e) : !!(t && "string" == typeof t.is)
    }, n.setStyleProp = function(e, t) {
        if ("string" == typeof e) {
            if (!e.trim()) {
                t.style = {};
                return
    ...
    n.PRESERVE_CUSTOM_ATTRIBUTES = Number(o.version.split(".")[0]) >= 16, n.ELEMENTS_WITH_NO_TEXT_CHILDREN = new Set(["tr", "tbody", "thead", "tfoot", "colgroup", "table", "head", "html", "frameset"]), n.canTextBeChildOfNode = function(e) {
    ...
    Object.defineProperty(n, "__esModule", {
        ...
        for (var u in e) {
            ...
            if (f) {
                ...
                switch (i.includes(f) && a.includes(t) && !c && (f = s("default" + d)), n[f] = p, null == h ? void 0 : h.type) {
                    case r.BOOLEAN:
                        n[f] = !0;
                        break;
            ...
            o.PRESERVE_CUSTOM_ATTRIBUTES && (n[u] = p)
        }
    ...
    Object.defineProperty(n, "__esModule", {
        ...
        void 0 === n && (n = {});
        for (var r, o, s, c, u, p = [], d = "function" == typeof n.replace, f = null != (r = n.transform) ? r : a.returnFirstArg, h = null != (o = n.library) ? o : l, m = h.cloneElement, g = h.createElement, y = h.isValidElement, v = t.length, E = 0; E < v; E++) {
            var b, x = t[E];
            if (d) {
                var T = null == (s = n.replace) ? void 0 : s.call(n, x, E);
                if (y(T)) {
                    v > 1 && (T = m(T, {
                        key: null != (c = T.key) ? c : E
                    })), p.push(f(T, x, E));
                    continue
                }
            }
            if ("text" === x.type) {
                var k = !x.data.trim().length;
                if (k && x.parent && !(0, a.canTextBeChildOfNode)(x.parent) || n.trim && k) continue;
                p.push(f(x.data, x, E));
                continue
            }
            var _ = {};
            (b = x, a.PRESERVE_CUSTOM_ATTRIBUTES && "tag" === b.type && (0, a.isCustomComponent)(b.name, b.attribs)) ? ((0, a.setStyleProp)(x.attribs.style, x.attribs), _ = x.attribs) : x.attribs && (_ = (0, i.default)(x.attribs, x.name));
            var C = void 0;
            switch (x.type) {
                case "script":
                case "style":
                    x.children[0] && (_.dangerouslySetInnerHTML = {
                        __html: x.children[0].data
                    });
                    break;
                case "tag":
                    "textarea" === x.name && x.children[0] ? _.defaultValue = x.children[0].data : (null == (u = x.children) ? void 0 : u.length) && (C = e(x.children, n));
                    break;
                default:
                    continue
            }
            v > 1 && (_.key = E), p.push(f(g(x.name, _, C), x, E))
        }
    ...
    Object.defineProperty(n, "__esModule", {
        value: !0
    }), n.htmlToDOM = n.domToReact = n.attributesToProps = n.Text = n.ProcessingInstruction = n.Element = n.Comment = void 0, n.default = function(e, t) {
        var n;
        if ("string" != typeof e) throw TypeError("First argument must be a string");
        return e ? (0, i.default)((0, o.default)(e, null != (n = null == t ? void 0 : t.htmlparser2) ? n : l), t) : []
    };
    var o = r(e.r(71883));
    n.htmlToDOM = o.default, n.attributesToProps = r(e.r(12467)).default;
    var i = r(e.r(54465));
    n.domToReact = i.default;
    var a = e.r(92599);
    ...
    "use strict";
    var t = e.i(17870);
    let n = t.default.default || t.default;
    e.s(["default", 0, n])
}]);